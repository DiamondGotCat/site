  ...
  <main>
    ...
    <div class="hero bg-base-200 min-h-screen">
      <div class="hero-content text-center">
        <div class="max-w-md">
            <h1 class="text-5xl font-bold">from Text</h1>

            <div class="divider"></div>
            
            <form action="../process" method="GET">
                <div class="flex basis-0">
                    <input type="text" name="url" placeholder="Enter Text..." class="input input-bordered w-full max-w-xs" />
            ...
            <a href="/t/"><button class="btn btn-primary">Use</button></a>
